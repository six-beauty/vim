...
function! PdbMapKeyboard()
	...
	map <buffer> <silent> <F6> :call PdbStartDebug(1, [])<CR>
	" Start debug and don't pause immediately.
	map <buffer> <silent> <C-F6> :call PdbStartDebug(0, [])<CR>
	map <buffer> <silent> <C-S-F6> :call PdbStartDebugWithArguments()<CR>
	map <buffer> <silent> <S-F6> :call PdbStopDebug()<CR>
	map <buffer> <silent> <C-A-S-F6> :call PdbRestartDebug()<CR>
	...
	map <buffer> <silent> <F10> :call PdbStepOver()<CR>
	map <buffer> <silent> <F11> :call PdbStepInto()<CR>
	map <buffer> <silent> <C-F10> :call PdbContinueUntilReturn()<CR>
...
"
"	map <buffer> <silent> <F9> :call PdbToggleBreakpointOnCurrentLine()<CR>
"	map <buffer> <silent> <C-F9> :call PdbToggleConditionalBreakpointOnCurrentLine()<CR>
"	map <buffer> <silent> <S-F9> :call PdbToggleTemporaryBreakpointOnCurrentLine()<CR>
"	map <buffer> <silent> <C-S-F9> :call PdbClearAllBreakpointsInCurrentFile()<CR>
"	map <buffer> <silent> <C-A-S-F9> :call PdbClearAllBreakpoints()<CR>
"
